...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // added
    /*  display_element.querySelector('#jspsych-canvas-slider-response-response').addEventListener('input', function () {
        var slider_value = document.querySelector('input').value;

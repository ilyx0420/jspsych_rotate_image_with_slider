...
jsPsych.plugins["html-button-response-circle"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      button_html: {
        ...
        default: '<button class="jspsych-btn" style="padding:1px 1px"><img src="%choice%" width="100"></button>',
        array: true,
  ...
  plugin.trial = function(display_element, trial) {
    ...
    paper.innerHTML  += "<div><img style='position:relative; top: 17.5px; max-width:89%;' src='img/colorim3.png' /></div>";
 ...
 /*  if (trial.fixation_html !== null) {
       ...
       paper.innerHTML  += "<div><img src='img/colorim.jpg'/></div>";
      } */

...
jsPsych.plugins['survey-dropdown-new'] = (function() {
  var plugin = {};

  plugin.info = {
    name: 'survey-dropdown-new',
    description: '',
    parameters: {
      questions: {
...
//html += '<button type="submit" onclick="return doSomething(this)" style="visibility: hidden;">continue</button>';

...
jsPsych.plugins['html-slider-response-round'] = (function() {
         
  var plugin = {};

  plugin.info = {
    name: 'html-slider-response-round',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
   ...
   // }
   // html += '">';
    //html += '<input type="range" class="c-rng" min="0" max="360" step="1" value="75" data-range="circular" />';

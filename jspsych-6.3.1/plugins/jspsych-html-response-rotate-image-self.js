...
jsPsych.plugins['html-response-rotate-image-self'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'html-response-rotate-image-self',
    description: '',
    parameters: {
      stimulus: {
...
////
html += '<div id="jspsych-image-resize-response-handle" style="cursor: move; background-color: steelblue; width: 10px; height: 10px; border: 2px solid lightsteelblue; position: absolute; bottom: 0; right: 0;"></div>';
///
